    ...
    const styles = [
        {
            ...
            desc: "L'agence Afnane photographie vous propose des séances photo personnalisées et uniques, pour une expérience mémorable. Nous avons à cœur de créer pour vous des moments doux, joyeux et simples pour capturer une série de portraits naturels et intimes de votre bébé et de votre famille.",
        },
        {
