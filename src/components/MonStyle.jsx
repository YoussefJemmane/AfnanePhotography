...
const MonStyle = () => {
    ...
    const styles = [
        {
            text: "Séance photo personnalisée et unique",
            desc: "Afnane photography vous propose des séances photo personnalisées et uniques, pour une expérience mémorable. Nous avons à cœur de créer pour vous des moments doux, joyeux et simples pour capturer une série de portraits naturels et intimes de votre bébé et de votre famille.",
        },
        {
            text: "Accompagnement personnalisé",
            desc: "Nous vous accompagnerons dans le choix du style de vos photos, la sélection des mises en scène et des couleurs. Nous mettrons à votre disposition un ensemble de bloomers, habits, bonnets, bandeaux pour les filles et wraps, et nous vous montrerons les accessoires et les décors que nous avons prévus. Nous affinerons ensemble, en fonction de vos goûts, et de ce que vous avez apporté."
        }
    ]
    return (
