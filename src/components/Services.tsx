      ...
      <div className="pt-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {services.map((service, index) => (
            <div key={index} className="h-64 sm:h-96 relative group">
              <Image src={service.image} alt={service.name} layout="fill" objectFit="cover" objectPosition={service.position} className='border'/>
